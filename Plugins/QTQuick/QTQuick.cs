...
namespace Qwop {
    ...
    /// </summary>
    [Plugin(PluginType.Interactive, Author = "indiff", Name = "���?", Version = "1.0.0.1", Description = "��QTѡ��;����������Դ������")]
        ...
        public void OnDropDownOpening(ToolStripDropDownMenu menu) {
            ...
            if(fFirstMenuDropDown) {
              ...
              //  menu.Items.Add(new ToolStripMenuItem("���õ�ǰĿ¼M2_HOME"));
                ...
                menu.Items.Add(new ToolStripMenuItem("������Դ������")); 
                menu.Items.Add(new ToolStripMenuItem("�ػ�"));

              //  menu.Items.Add(new ToolStripMenuItem("���õ�ǰĿ¼ANT_HOME"));
             //   menu.Items.Add(new ToolStripMenuItem("���õ�ǰĿ¼MVND_HOME"));

                menu.Items.Add(new ToolStripMenuItem("����Path"));
                menu.Items.Add(new ToolStripMenuItem("ɾ��QTTabGroup�������"));
                menu.Items.Add(new ToolStripMenuItem("��QTTabBar�쳣��־"));
        ...
        public void OnDropDownItemClick(ToolStripItem item, MouseButtons mouseButton) {
            ...
            if (mouseButton == MouseButtons.Left)
            {
                switch (idx)
                {
                    ...
                    case 7:
                        {
                            ...
                            if (File.Exists(exePath))
                            {
                                ...
                                MessageBox.Show( "δ�ҵ���ִ���ļ�SetHome");
                            }
                            break;
                        }
                    ...
                    case 9:  // ɾ�� QTTabBarException.log
                    {
