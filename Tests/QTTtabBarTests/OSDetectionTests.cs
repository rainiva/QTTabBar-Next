...
namespace QTTtabBarTests
{
    ...
    public class OSDetectionTests
    {
        ...
        public void CheckIsWin10_False_OnWin11_Build22000()
        {
            ...
            Assert.IsFalse(QTUtility.CheckIsWin10(new Version(10, 0, 22000, 0)));
        }
        ...
        {
            // Windows 11 23H2
            Assert.IsFalse(QTUtility.CheckIsWin10(new Version(10, 0, 22631, 0)));
        }
        ...
        {
            // Windows 10 2004
            Assert.IsTrue(QTUtility.CheckIsWin10(new Version(10, 0, 19041, 0)));
        }
        ...
        {
            // Windows 10 RTM
            Assert.IsTrue(QTUtility.CheckIsWin10(new Version(10, 0, 10240, 0)));
        }
        ...
        public void CheckIsWin10_False_OnWin7()
        {
            ...
            Assert.IsFalse(QTUtility.CheckIsWin10(new Version(6, 1, 7601, 0)));
        }
        ...
        public void CheckIsWin10_False_OnWin8()
        {
            ...
            Assert.IsFalse(QTUtility.CheckIsWin10(new Version(6, 2, 9200, 0)));
        }
        ...
        public void CheckIsWin10_True_OnWin10_Threshold_Compat()
        {
            ...
            Assert.IsTrue(QTUtility.CheckIsWin10(new Version(6, 4, 0, 0)));
        }
        ...
        public void IsWin10_And_IsWin11_Are_Mutually_Exclusive()
        {
            ...
            {
                Assert.IsFalse(QTUtility.IsWin10,
