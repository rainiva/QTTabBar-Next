namespace QTTabBarLib {
    ...
    internal static class ThemeRefreshService {
        ...
        /// <summary>
        /// Local-only theme refresh for WM_SYSCOLORCHANGE: updates runtime skin and
        /// Fluent tokens without persisting or broadcasting ReloadConfig to peers.
        /// </summary>
        public static void RefreshLocalThemeAndUi() {
