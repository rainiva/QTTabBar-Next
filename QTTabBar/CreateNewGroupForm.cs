...
namespace QTTabBarLib {
    internal sealed class CreateNewGroupForm : Form {
        ...
        public CreateNewGroupForm(string currentPath, QTabControl.QTabCollection tabs) {
            ...
            string[] strArray = ResourceCache.TextResourcesDic["TabBar_NewGroup"]; // 新增标签组;标签组名称:;加入所有标签
            // 设置 form 标题为路径信息
        ...
        private void InitializeComponent() {
            ...
            buttonOK.TabIndex = 0;
            buttonOK.Text = ResourceCache.TextResourcesDic["DialogButtons"][0]; // 确定
            buttonOK.Click += buttonOK_Click;
            buttonCancel.DialogResult = DialogResult.Cancel;
            buttonCancel.Location = new Point(516, 87);  // 取消按钮位置
            buttonCancel.Size = new Size(94, 29); // 0x17 -> 0x19 by indiff
            buttonCancel.TabIndex = 1;
            buttonCancel.Text = ResourceCache.TextResourcesDic["DialogButtons"][1];// 取消
