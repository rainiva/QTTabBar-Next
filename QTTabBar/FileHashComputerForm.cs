...
namespace QTTabBarLib {
    internal sealed class FileHashComputerForm : Form {
        ...
        private void InitializeComponent() {
            ...
            clmn2_Path.HeaderText = ResourceCache.TextResourcesDic["FileHashComputer"][0];
            clmn2_Path.MinimumWidth = 80;
            clmn2_Path.ReadOnly = true;
            clmn3_Hash.AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
            clmn3_Hash.HeaderText = ResourceCache.TextResourcesDic["FileHashComputer"][1];
            ...
            btnClose.Text = ResourceCache.TextResourcesDic["FileHashComputer"][2];
            ...
            btnClear.Text = ResourceCache.TextResourcesDic["FileHashComputer"][3];
            btnClear.UseVisualStyleBackColor = true;
            btnClear.Click += buttonClear_Click;
            btnRefresh.Location = new Point(0x89, 8);
            btnRefresh.Size = new Size(0x4b, 0x15);
            btnRefresh.Text = ResourceCache.TextResourcesDic["FileHashComputer"][4];
            ...
            chbTopMost.Text = ResourceCache.TextResourcesDic["FileHashComputer"][5];
            ...
            chbShowResult.Text = ResourceCache.TextResourcesDic["FileHashComputer"][6];
            ...
            chbClearOnClose.Text = ResourceCache.TextResourcesDic["FileHashComputer"][7];
            ...
            chbFullPath.Text = ResourceCache.TextResourcesDic["FileHashComputer"][8];
            ...
            Text = ResourceCache.TextResourcesDic["FileHashComputer"][1];
        ...
        public void ShowFileHashForm(string[] paths) {
            if(!fCancellationPending) {
                ClearNewColor();
                Text = MakeHashTypeText() + ResourceCache.TextResourcesDic["FileHashComputer"][9];
