...
namespace QTTabBarLib {
    internal sealed class TabSwitchForm : Form {
        ...
        private void DrawItems(Graphics g) {
            ...
            int num2 = fCompositionEnabled ? 0 : (!OSDetector.IsXP ? 2 : 8);
            int y = !OSDetector.IsXP ? 4 : 8;
            int num4 = TabSwitchForm.menuHeight + (!OSDetector.IsXP ? 11 : 0x12);
        ...
        private static Image GetImage(PathData pathData) {
            ...
            if(!IconManager.ImageGlobalContainsKey(strImageKey)) {
                strImageKey = IconManager.GetImageKey(pathData.strPath, null);
            }
            return IconManager.GetImageFromGlobal(strImageKey);
        }
        ...
        public void ShowSwitcher(IntPtr hwndExplr, int indexCurrent, List<PathData> lstPaths) {
            ...
            if(!OSDetector.IsXP && (PInvoke.DwmIsCompositionEnabled(out fCompositionEnabled) != 0)) {
