//    File tools controller extracted from QTTabBarClass (arch-batch3c6d).
...
namespace QTTabBarLib {
    public partial class QTTabBarClass {
        internal class FileToolsController {
            private readonly QTTabBarClass _owner;
            private static FileHashComputerForm md5Form;

            public FileToolsController(QTTabBarClass owner) {
                _owner = owner;
            }
            ...
            public bool DoFileTools(int index) {
                try {
                    ...
                    switch(index) {
                        ...
                        case 4:
                            string str2;
                            if(!_owner.ShellBrowser.TryGetSelection(out addressArray, out str2, index == 1)) {
                                goto Label_019C;
                            }
