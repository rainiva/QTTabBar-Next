    ...
    public partial class QTTabBarClass {
        internal class ComponentBuildController {
            ...
            public void Build() {
                ...
                _owner._shellUiController = new ShellUiController((IShellUiHost)_owner);
                ...
                _owner._tabTooltipController = new TabTooltipController((ISubDirTipHost)_owner);
                _owner._windowManagementController = new WindowManagementController((IWindowManagementHost)_owner);
                ...
                _owner._pluginMenuController = new PluginMenuController((IPluginMenuHost)_owner);
                _owner._shutdownController = new ShutdownController((IShutdownResourceHost)_owner, (IShutdownPersistenceHost)_owner);
